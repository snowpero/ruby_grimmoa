...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { created_on: @notice.created_on, link: @notice.link, title: @notice.title, writer: @notice.writer }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { created_on: @notice.created_on, link: @notice.link, title: @notice.title, writer: @notice.writer }
    assert_redirected_to notice_path(assigns(:notice))
  end
